...
static Lpspi_Ip_DeviceParamsType Lpspi_Ip_DeviceParamsCfg[6U] =
{
    {
        (uint8)16U, /* Frame size */
        (boolean)FALSE, /*Lsb */
        (uint32)65535U  /* Default Data */
...
{
    1U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(3U) | LPSPI_CCR_PCSSCK(3U) | LPSPI_CCR_SCKDIV(6U) | LPSPI_CCR_DBT(38U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(0U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(0U) | LPSPI_TCR_CONT(1U)) /* TCR */
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_1_Instance_1 =
{
    1U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(3U) | LPSPI_CCR_PCSSCK(3U) | LPSPI_CCR_SCKDIV(6U) | LPSPI_CCR_DBT(38U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(0U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(1U) | LPSPI_TCR_CONT(1U)) /* TCR */
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_2_Instance_2 =
{
    2U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(3U) | LPSPI_CCR_PCSSCK(3U) | LPSPI_CCR_SCKDIV(6U) | LPSPI_CCR_DBT(38U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(0U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(0U) | LPSPI_TCR_CONT(1U)) /* TCR */
...
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_3 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_3_Instance_2 =
{
    2U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(3U) | LPSPI_CCR_PCSSCK(3U) | LPSPI_CCR_SCKDIV(6U) | LPSPI_CCR_DBT(38U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(0U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(1U) | LPSPI_TCR_CONT(1U)) /* TCR */
    ...
    ,(uint32)0U /* This device do not support half duplex mode */
#endif
    , &Lpspi_Ip_DeviceParamsCfg[3U]
};

/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_4 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_4_Instance_3 =
{
    3U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(39U) | LPSPI_CCR_PCSSCK(39U) | LPSPI_CCR_SCKDIV(78U) | LPSPI_CCR_DBT(254U)), /* ccr */
    ...
    ,(uint32)0U /* This device do not support half duplex mode */
#endif
    , &Lpspi_Ip_DeviceParamsCfg[4U]
};

/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_5 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_5_Instance_4 =
{
    4U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(3U) | LPSPI_CCR_PCSSCK(3U) | LPSPI_CCR_SCKDIV(6U) | LPSPI_CCR_DBT(38U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(0U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(0U) | LPSPI_TCR_CONT(1U)) /* TCR */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_Instance_2 =
{
    2U,  /* Instance */
     /* CR */
    (uint32)0,
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_2_Instance_3 =
{
    3U,  /* Instance */
     /* CR */
    (uint32)0,
...
/* SPI controller SpiPhyUnit_3 configuration. */
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_3_Instance_4 =
{
    4U,  /* Instance */
     /* CR */
    (uint32)0,
    ...
    #endif
    LPSPI_IP_POLLING, /* Transfer mode */
    (uint8)3U /* State structure element from the array */
    #if (LPSPI_IP_DMA_USED == STD_ON)
    ,(boolean)FALSE  /* If channels in HWunit are the same framesize. */
    ,(uint8)0U
    #endif
