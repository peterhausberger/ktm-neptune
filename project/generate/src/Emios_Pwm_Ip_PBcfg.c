...
/* Emios PWM mode configuration structure for PwmEmios_0/PwmEmiosChannels_4 */
...
/* Emios PWM mode configuration structure for PwmEmios_0/PwmEmiosChannels_5 */
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I0_Ch5 =
{
    /* .ChannelId */            5U,
    /* .Mode */                 EMIOS_PWM_IP_MODE_OPWMB_FLAG,
    /* .Timebase */             EMIOS_PWM_IP_BUS_A,
...
/* Emios PWM mode configuration structure for PwmEmios_0/PwmEmiosChannels_6 */
