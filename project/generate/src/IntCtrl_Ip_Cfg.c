...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration1[] = {
    ...
    {LPSPI2_IRQn, (boolean)TRUE, 7U, Lpspi_Ip_LPSPI_2_IRQHandler},
    {LPI2C0_IRQn, (boolean)TRUE, 5U, LPI2C0_Master_Slave_IRQHandler},
    {LPI2C1_IRQn, (boolean)TRUE, 6U, LPI2C1_Master_Slave_IRQHandler},
    {LPSPI3_IRQn, (boolean)TRUE, 7U, Lpspi_Ip_LPSPI_3_IRQHandler},
    {LPSPI4_IRQn, (boolean)TRUE, 7U, Lpspi_Ip_LPSPI_4_IRQHandler},
};
